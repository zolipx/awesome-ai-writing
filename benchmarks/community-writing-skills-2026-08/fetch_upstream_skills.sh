...
curl -fsSL "https://raw.githubusercontent.com/harshaneel/humanize/4ec797314537ec9c2105f276d4561d240a0390ba/ai-check/SKILL.md" -o "$DEST/humanize-ai-check.SKILL.md"
