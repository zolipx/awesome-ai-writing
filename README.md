...
一个面向中文与英文创作者的开源项目索引，集中收集 **AI 小说、长篇叙事、AI 写作工作台、故事生成、写作 Agent、Prompt/工作流**，以及 **去除 AI 味道、改善文本自然度的人类化工具**。

> 这是一个链接目录，不复制、镜像或打包被收录项目的源码。请在使用前自行检查项目的许可证、隐私政策、依赖和维护状态。
...
| [MaliangAINovalWriter](https://github.com/Deng-m1/MaliangAINovalWriter) | 面向中文网文的多智能体小说创作平台，支持大纲、知识图谱和连载 | 未标注 |
...
| [AI-Novel-Writer](https://github.com/EthanYoQ/AI-Novel-Writer) | 支持大纲、角色、章节蓝图、审稿修稿和知识库的小说工作台 | TypeScript |
...
| 项目 | 简介 | 语言 |
| --- | --- | --- |
| [awesome-ai-research-writing](https://github.com/Leey21/awesome-ai-research-writing) | AI 研究写作与润色资源集合 | 未标注 |
...
这一类项目用于识别或减少模板化、套话、过度规整、机械连接词等 AI 写作特征。**“更像人”不等于绕过检测器**；建议把它们当作编辑、风格审校和可读性工具使用，并保留事实核查与作者最终判断。
...
| [humanize](https://github.com/harshaneel/humanize) | 基于研究资料的 LLM 无关文本人类化 Skills | HTML |
| [humanizer-ru](https://github.com/smixs/humanizer-ru) | 面向俄语文本的 AI 写作痕迹审计与人类化 Skill | Python |
...
| [StealthHumanizer](https://github.com/rudra496/StealthHumanizer) | 多语言文本人类化工具，支持多种提供商、风格和语气 | TypeScript |
...
| [anti-ai-writing-claude-skill](https://github.com/avikbal-dm/anti-ai-writing-claude-skill) | 面向 Claude 的 AI 写作人类化 Skill | 未标注 |
| [humanizer-workbench](https://github.com/aprempeh-tech/humanizer-workbench) | CLI 与 Claude Code Skill，检测 AI 模式并改善语气和节奏 | Python |
...
- 优先收录有明确用途、可运行说明、许可证或活跃维护记录的项目。
- 收录描述只做导航，不代表本项目维护者为其背书。
- 不收录明显窃取内容、恶意软件、虚假检测保证或违反平台规则的项目。
